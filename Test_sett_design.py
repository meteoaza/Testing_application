...
class Ui_Frame(object):
    def setupUi(self, Frame):
        ...
        self.colTimeLine = QtWidgets.QLineEdit(Frame)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.colTimeLine.sizePolicy().hasHeightForWidth())
        self.colTimeLine.setSizePolicy(sizePolicy)
        self.colTimeLine.setMaximumSize(QtCore.QSize(20, 14))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.colTimeLine.setFont(font)
        self.colTimeLine.setText("")
        self.colTimeLine.setAlignment(QtCore.Qt.AlignCenter)
        self.colTimeLine.setObjectName("colTimeLine")
        self.horizontalLayout_2.addWidget(self.colTimeLine)
    ...
    def retranslateUi(self, Frame):
        ...
        self.label_12.setText(_translate("Frame", "сек"))
